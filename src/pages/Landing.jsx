...
export function LandingPage() {
  ...
  "@graph": [
    ...
    },
    {
      ...
      {/* NAV */}
      <nav className="fixed top-0 left-0 right-0 z-[100] h-[64px] flex items-center justify-between px-[24px] sm:px-[48px] bg-white/92 backdrop-blur-[12px] border-b border-[#E2E6F0]">
        <Link to="/" className="flex items-center gap-[9px] no-underline" aria-label="DegreeIQ home">
          ...
          <span className="text-[clamp(0.9rem,2.5vw,1.15rem)] font-bold text-[#0F2145] tracking-[-0.02em]">DegreeIQ</span>
        </Link>
        <span className="hidden sm:inline text-[0.8rem] font-medium text-[#6B7A99] tracking-[0.01em]">CS Department · COMSATS Islamabad</span>
      </nav>
